...
#include <stdint.h>
#include <stdbool.h>
#include <stddef.h>  // 修正: 添加 stddef.h 以支援 size_t
...
/** 修正: 添加缺失的常數定義 */
/** Ping timeout in milliseconds (for heartbeat) */
#define WS_PING_TIMEOUT_MS          3000

/** Initial reconnect delay in milliseconds */
#define WS_RECONNECT_INTERVAL_MS    1000

/** Maximum reconnect delay in milliseconds */
#define WS_MAX_RECONNECT_INTERVAL_MS 60000
